...
export default function Tables() {
    useEffect(() => {
        ...
        scriptJquery.src = "vendor/datatables/jquery.dataTables.min.js";

        document.body.appendChild(scriptJquery);

        const scriptTable = document.createElement("script")

        scriptTable.src = "vendor/datatables/dataTables.bootstrap4.min.js";

        document.body.appendChild(scriptTable)

        const scriptDemo = document.createElement("script")

        scriptDemo.src = "js/demo/datatables-demo.js";
        ...
        return () => {
            ...
            document.body.removeChild(scriptTable);
